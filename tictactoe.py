...
True, or False, respectively meaning 'empty', 'X', and '0'.
...
class TicTacToeBoard(_TTTB, Node):
    def find_children(board):
        if board.terminal:  # If the game is finished then no moves can ne made
            return set()
    ...
    def reward(board):
        ...
        if board.winner is board.turn:
            # It's your turn and you have already won. Should be impossible
...
def play_game():
    ...
    while True:
        ...
        if board.terminal:
            break
        # You can train as you go, on only at the beginning
